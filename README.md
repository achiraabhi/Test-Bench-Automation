...
Click **Scan** to discover instruments and **Start** to stream live readings. Connected instruments can be disconnected and reconnected individually from the dashboard.
